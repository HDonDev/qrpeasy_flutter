...
class _MobileViewState extends State<MobileView> {
  ...
  Future<void> _postFCMToken(String url, int id) async {
  ...
  Future<int?> _getUserId(String url) async {
    print('[DEBUG] $url');
  ...
  Future<void> _goToUserIdEndpoint() async {
    _pageStatus.set(PageStatus.gettingUserData);
